    ...
    >
      <defs>
        <linearGradient id="heartGradient" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" style={{ stopColor: darkMode ? 'red' : 'red', stopOpacity: 1 }} />
          <stop offset="100%" style={{ stopColor: darkMode ? '#262626' : 'red', stopOpacity: 1 }} />
        </linearGradient>
      </defs>
      <path
        id="like"
        ...
        fill="url(#heartGradient)" // Apply the gradient fill
      />
    </svg>
  );
}
